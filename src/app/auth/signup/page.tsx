        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 w-full max-w-md">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center">
            <p className="text-[#4954E0] opacity-70">
              ...
              <Link href="/signup" className="font-medium opacity-100">
                Sign up
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <button className="flex items-center justify-center py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-all">
